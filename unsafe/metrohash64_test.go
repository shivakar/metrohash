...
import (
	...
	metrohash "github.com/shivakar/metrohash/unsafe"
...
func BenchmarkMetroHash64_unsafe_1kb(b *testing.B) {
	in := make([]byte, 1024)
	rand.Read(in)
	h := metrohash.NewMetroHash64()
	benchHash(b, h, in)
...
func BenchmarkMetroHash64_unsafe_1mb(b *testing.B) {
...
func BenchmarkMetroHash64_unsafe(b *testing.B) {
	h := metrohash.NewMetroHash64()
